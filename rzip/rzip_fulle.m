...
% LI,             an external input for li consistant with above
  ...
  function [A, B, C, D, curlyM, curlyR, plasma_outputs, IFLAG] = ...
               rzip_fulle(shot, time, Used_coils, N_eigen_modes, plasma_inputs, Machine_name, force_make, extra_routine);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INITIALISATION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Create two file name variables to the output files.
  plasma_less_file  = [Machine_name,'_plasma_less_fulle.mat'];
  plasma_full_file  = [Machine_name,'_plasma_full_fulle.mat'];
...
% set maximum number of emodes
  if(N_eigen_modes  > N_passive_fils)
   N_eigen_modes  = N_passive_fils; 
   if(screen_is_on); disp('More eigenmodes than points, have reset N_eigen_modes '); end;
  end;  
...
% for destabilising force analysis
 save destab_fulle.mat dL_plas_struct_dz L_struct IP
