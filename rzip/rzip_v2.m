...
% LI,             an external input for li consistant with above
  ...
  function [A, B, C, D, curlyM, curlyR, plasma_outputs, IFLAG] = ...
               rzip_v2(shot, time, Used_coils, N_eigen_modes, plasma_inputs, Machine_name, force_make, extra_routine);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INITIALISATION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Create two file name variables to the output files.
  plasma_less_file  = [Machine_name,'_plasma_less_v2.mat'];
  plasma_full_file  = [Machine_name,'_plasma_full_v2.mat'];
...
% If we have disturbances then we need to rearrange things
 if(make_disturb)
  e_dist = -mu0*IP*IP/2;
  E      = minv*[zeros(N_Used_coils+N_eigen_modes+1,2); e_dist e_dist/2; 0 0];
